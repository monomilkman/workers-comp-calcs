...
import { Plus, Trash2, Download, FileText, File, Car, AlertCircle } from 'lucide-react';
import type { MVASettlementData, Lien, Expense, ClientInfo } from '../types/settlement';

export function MVASettlementCalculator() {
  ...
  const settlementData: MVASettlementData = {
    grossSettlement,
    attorneyFeePercent,
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      link.download = `mva-settlement-${new Date().toISOString().split('T')[0]}.pdf`;
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Calculate attorney fees, case expenses, lien reductions, and net settlement distribution for MVA cases.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="mva-attorney-name" className="input-label">
              Attorney Name
            </label>
            <input
              type="text"
              id="mva-attorney-name"
          ...
          <div>
            <label htmlFor="mva-client-name" className="input-label">
              Client Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="mva-address" className="input-label">
              Address
            </label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="col-span-2">
              <label htmlFor="mva-city" className="input-label">
                City
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="mva-state" className="input-label">
                State
              </label>
              <input
                type="text"
          ...
          <div>
            <label htmlFor="mva-zip" className="input-label">
              ZIP Code
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="mva-date-of-injury" className="input-label">
              Date of Injury
            </label>
            <input
              type="date"
              id="mva-date-of-injury"
          ...
          <div>
            <label htmlFor="mva-statement-date" className="input-label">
              Date
            </label>
            <input
              type="date"
              id="mva-statement-date"
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="mva-gross-settlement" className="input-label">
          ...
          <div>
            <label htmlFor="mva-attorney-fee" className="input-label">
              Attorney Fee %
            </label>
            <input
              type="number"
